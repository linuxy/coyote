...
pub extern fn _Py_bit_length(d: c_ulong) c_uint;
...
pub fn _Py_IS_TYPE(arg_ob: [*c]const PyObject, arg_type: [*c]const PyTypeObject) callconv(.C) c_int {
    var ob = arg_ob;
    var @"type" = arg_type;
    return @boolToInt(ob.*.ob_type == @intToPtr([*c]PyTypeObject, @ptrToInt(@"type")));
}
pub fn _Py_SET_REFCNT(arg_ob: [*c]PyObject, arg_refcnt: Py_ssize_t) callconv(.C) void {
    var ob = arg_ob;
    var refcnt = arg_refcnt;
    ob.*.ob_refcnt = refcnt;
}
pub fn _Py_SET_TYPE(arg_ob: [*c]PyObject, arg_type: [*c]PyTypeObject) callconv(.C) void {
    var ob = arg_ob;
    var @"type" = arg_type;
    ob.*.ob_type = @"type";
}
pub fn _Py_SET_SIZE(arg_ob: [*c]PyVarObject, arg_size: Py_ssize_t) callconv(.C) void {
    var ob = arg_ob;
    var size = arg_size;
    ob.*.ob_size = size;
}
...
pub extern fn PyType_GetModule([*c]struct__typeobject) [*c]PyObject;
pub extern fn PyType_GetModuleState([*c]struct__typeobject) ?*anyopaque;
...
pub fn _Py_DECREF(arg_op: [*c]PyObject) callconv(.C) void {
    var op = arg_op;
    if ((blk: {
...
pub extern fn _PyTrash_begin(tstate: [*c]struct__ts, op: [*c]PyObject) c_int;
pub extern fn _PyTrash_end(tstate: [*c]struct__ts) void;
pub fn PyType_HasFeature(arg_type: [*c]PyTypeObject, arg_feature: c_ulong) callconv(.C) c_int {
    ...
    flags = @"type".*.tp_flags;
    return @boolToInt((flags & feature) != @bitCast(c_ulong, @as(c_long, @as(c_int, 0))));
}
pub fn _PyType_Check(arg_op: [*c]PyObject) callconv(.C) c_int {
    var op = arg_op;
    return PyType_HasFeature(op.*.ob_type, @as(c_ulong, 1) << @intCast(@import("std").math.Log2Int(c_ulong), 31));
}
pub fn _PyType_CheckExact(arg_op: [*c]PyObject) callconv(.C) c_int {
    var op = arg_op;
    return _Py_IS_TYPE(@ptrCast([*c]const PyObject, @alignCast(@import("std").meta.alignment(PyObject), op)), &PyType_Type);
}
...
pub fn _PyObject_INIT(arg_op: [*c]PyObject, arg_typeobj: [*c]PyTypeObject) callconv(.C) [*c]PyObject {
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (op != @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {} else {
                __assert_fail("op != NULL", "/usr/include/python3.9/cpython/objimpl.h", @bitCast(c_uint, @as(c_int, 67)), "PyObject *_PyObject_INIT(PyObject *, PyTypeObject *)");
            };
        };
    };
    _Py_SET_TYPE(op, typeobj);
...
pub fn _PyObject_INIT_VAR(arg_op: [*c]PyVarObject, arg_typeobj: [*c]PyTypeObject, arg_size: Py_ssize_t) callconv(.C) [*c]PyVarObject {
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (op != @ptrCast([*c]PyVarObject, @alignCast(@import("std").meta.alignment(PyVarObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {} else {
                __assert_fail("op != NULL", "/usr/include/python3.9/cpython/objimpl.h", @bitCast(c_uint, @as(c_int, 82)), "PyVarObject *_PyObject_INIT_VAR(PyVarObject *, PyTypeObject *, Py_ssize_t)");
            };
        };
    };
...
pub const _Py_HashSecret_t = extern union {
    uc: [24]u8,
    fnv: struct_unnamed_11,
    siphash: struct_unnamed_12,
    djbx33a: struct_unnamed_13,
    expat: struct_unnamed_14,
};
...
pub extern fn wmempcpy(noalias __s1: [*c]wchar_t, noalias __s2: [*c]const wchar_t, __n: usize) [*c]wchar_t; // /usr/include/wchar.h:320:11: warning: TODO implement function '__builtin_constant_p' in std.zig.c_builtins
...
pub fn Py_UNICODE_COPY(arg_target: [*c]Py_UNICODE, arg_source: [*c]const Py_UNICODE, arg_length: Py_ssize_t) callconv(.C) void {
    var target = arg_target;
    var source = arg_source;
    var length = arg_length;
    _ = memcpy(@ptrCast(?*anyopaque, target), @ptrCast(?*const anyopaque, source), @bitCast(usize, length) *% @sizeOf(Py_UNICODE));
}
pub fn Py_UNICODE_FILL(arg_target: [*c]Py_UNICODE, arg_value: Py_UNICODE, arg_length: Py_ssize_t) callconv(.C) void {
    var target = arg_target;
    var value = arg_value;
    var length = arg_length;
    var i: Py_ssize_t = undefined;
    {
        i = 0;
        while (i < length) : (i += 1) {
            (blk: {
...
} // /usr/include/python3.9/cpython/unicodeobject.h:171:22: warning: struct demoted to opaque type - has bitfield
const struct_unnamed_16 = opaque {};
pub const PyASCIIObject = extern struct {
    ob_base: PyObject,
    length: Py_ssize_t,
    hash: Py_hash_t,
    state: struct_unnamed_16,
    wstr: [*c]wchar_t,
};
...
pub fn _PyUnicode_get_wstr_length(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    var op = arg_op;
    return if ((@bitCast(c_int, @ptrCast([*c]PyASCIIObject, @alignCast(@import("std").meta.alignment(PyASCIIObject), op)).*.state.ascii) != 0) and (@bitCast(c_int, @ptrCast([*c]PyASCIIObject, @alignCast(@import("std").meta.alignment(PyASCIIObject), op)).*.state.compact) != 0)) @ptrCast([*c]PyASCIIObject, @alignCast(@import("std").meta.alignment(PyASCIIObject), op)).*.length else @ptrCast([*c]PyCompactUnicodeObject, @alignCast(@import("std").meta.alignment(PyCompactUnicodeObject), op)).*.wstr_length;
}
...
pub const _PyASTOptimizeState = extern struct {
    optimize: c_int,
    ff_features: c_int,
};
pub extern fn _PyAST_Optimize(?*struct__mod, arena: ?*PyArena, state: [*c]_PyASTOptimizeState) c_int;
...
pub extern fn _PyEval_SetAsyncGenFirstiter([*c]PyObject) c_int;
pub extern fn _PyEval_GetAsyncGenFirstiter() [*c]PyObject;
pub extern fn _PyEval_SetAsyncGenFinalizer([*c]PyObject) c_int;
...
pub extern fn _PyEval_EvalFrameDefault(tstate: [*c]PyThreadState, f: ?*PyFrameObject, exc: c_int) [*c]PyObject;
...
pub fn PyVectorcall_Function(arg_callable: [*c]PyObject) callconv(.C) vectorcallfunc {
    var callable = arg_callable;
    var tp: [*c]PyTypeObject = undefined;
    var offset: Py_ssize_t = undefined;
    var ptr: vectorcallfunc = undefined;
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (callable != @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {} else {
                __assert_fail("callable != NULL", "/usr/include/python3.9/cpython/abstract.h", @bitCast(c_uint, @as(c_int, 72)), "vectorcallfunc PyVectorcall_Function(PyObject *)");
            };
        };
    };
    tp = callable.*.ob_type;
    if (!(PyType_HasFeature(tp, @as(c_ulong, 1) << @intCast(@import("std").math.Log2Int(c_ulong), 11)) != 0)) {
        return null;
    }
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (PyCallable_Check(callable) != 0) {} else {
                __assert_fail("PyCallable_Check(callable)", "/usr/include/python3.9/cpython/abstract.h", @bitCast(c_uint, @as(c_int, 77)), "vectorcallfunc PyVectorcall_Function(PyObject *)");
            };
        };
    };
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (offset > @bitCast(c_long, @as(c_long, @as(c_int, 0)))) {} else {
                __assert_fail("offset > 0", "/usr/include/python3.9/cpython/abstract.h", @bitCast(c_uint, @as(c_int, 79)), "vectorcallfunc PyVectorcall_Function(PyObject *)");
            };
        };
    };
...
pub fn _PyObject_VectorcallTstate(arg_tstate: [*c]PyThreadState, arg_callable: [*c]PyObject, arg_args: [*c]const [*c]PyObject, arg_nargsf: usize, arg_kwnames: [*c]PyObject) callconv(.C) [*c]PyObject {
    var tstate = arg_tstate;
    var callable = arg_callable;
    var args = arg_args;
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if ((kwnames == @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) or (PyType_HasFeature(kwnames.*.ob_type, @as(c_ulong, 1) << @intCast(@import("std").math.Log2Int(c_ulong), 26)) != 0)) {} else {
                __assert_fail("kwnames == NULL || PyTuple_Check(kwnames)", "/usr/include/python3.9/cpython/abstract.h", @bitCast(c_uint, @as(c_int, 110)), "PyObject *_PyObject_VectorcallTstate(PyThreadState *, PyObject *, PyObject *const *, size_t, PyObject *)");
            };
        };
    };
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if ((args != @ptrCast([*c]const [*c]PyObject, @alignCast(@import("std").meta.alignment([*c]PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) or (PyVectorcall_NARGS(nargsf) == @bitCast(c_long, @as(c_long, @as(c_int, 0))))) {} else {
                __assert_fail("args != NULL || PyVectorcall_NARGS(nargsf) == 0", "/usr/include/python3.9/cpython/abstract.h", @bitCast(c_uint, @as(c_int, 111)), "PyObject *_PyObject_VectorcallTstate(PyThreadState *, PyObject *, PyObject *const *, size_t, PyObject *)");
            };
        };
    };
...
pub fn PyObject_Vectorcall(arg_callable: [*c]PyObject, arg_args: [*c]const [*c]PyObject, arg_nargsf: usize, arg_kwnames: [*c]PyObject) callconv(.C) [*c]PyObject {
    var callable = arg_callable;
    var args = arg_args;
    var nargsf = arg_nargsf;
    var kwnames = arg_kwnames;
    var tstate: [*c]PyThreadState = PyThreadState_Get();
...
pub fn _PyObject_FastCallTstate(arg_tstate: [*c]PyThreadState, arg_func: [*c]PyObject, arg_args: [*c]const [*c]PyObject, arg_nargs: Py_ssize_t) callconv(.C) [*c]PyObject {
    var tstate = arg_tstate;
    var func = arg_func;
    var args = arg_args;
    var nargs = arg_nargs;
    return _PyObject_VectorcallTstate(tstate, func, args, @bitCast(usize, nargs), null);
}
...
pub fn _PyObject_CallNoArg(arg_func: [*c]PyObject) callconv(.C) [*c]PyObject {
    var func = arg_func;
    var tstate: [*c]PyThreadState = PyThreadState_Get();
    return _PyObject_VectorcallTstate(tstate, func, null, @bitCast(usize, @as(c_long, @as(c_int, 0))), null);
}
pub fn PyObject_CallOneArg(arg_func: [*c]PyObject, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    var func = arg_func;
    var arg = arg_arg;
    var _args: [2][*c]PyObject = undefined;
    var args: [*c][*c]PyObject = undefined;
    var tstate: [*c]PyThreadState = undefined;
    var nargsf: usize = undefined;
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (arg != @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {} else {
                __assert_fail("arg != NULL", "/usr/include/python3.9/cpython/abstract.h", @bitCast(c_uint, @as(c_int, 183)), "PyObject *PyObject_CallOneArg(PyObject *, PyObject *)");
            };
        };
    };
    args = @ptrCast([*c][*c]PyObject, @alignCast(@import("std").meta.alignment([*c]PyObject), &_args)) + @bitCast(usize, @intCast(isize, @as(c_int, 1)));
    args[@intCast(c_uint, @as(c_int, 0))] = arg;
    tstate = PyThreadState_Get();
    nargsf = @bitCast(c_ulong, @as(c_long, @as(c_int, 1))) | (@bitCast(usize, @as(c_long, @as(c_int, 1))) << @intCast(@import("std").math.Log2Int(usize), (@bitCast(c_ulong, @as(c_long, @as(c_int, 8))) *% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1)))));
...
pub fn PyObject_CallMethodNoArgs(arg_self: [*c]PyObject, arg_name: [*c]PyObject) callconv(.C) [*c]PyObject {
    var self = arg_self;
    var name = arg_name;
    return PyObject_VectorcallMethod(name, &self, @bitCast(c_ulong, @as(c_long, @as(c_int, 1))) | (@bitCast(usize, @as(c_long, @as(c_int, 1))) << @intCast(@import("std").math.Log2Int(usize), (@bitCast(c_ulong, @as(c_long, @as(c_int, 8))) *% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))), null);
}
pub fn PyObject_CallMethodOneArg(arg_self: [*c]PyObject, arg_name: [*c]PyObject, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (arg != @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {} else {
                __assert_fail("arg != NULL", "/usr/include/python3.9/cpython/abstract.h", @bitCast(c_uint, @as(c_int, 207)), "PyObject *PyObject_CallMethodOneArg(PyObject *, PyObject *, PyObject *)");
            };
        };
    };
    return PyObject_VectorcallMethod(name, @ptrCast([*c][*c]PyObject, @alignCast(@import("std").meta.alignment([*c]PyObject), &args)), @bitCast(c_ulong, @as(c_long, @as(c_int, 2))) | (@bitCast(usize, @as(c_long, @as(c_int, 1))) << @intCast(@import("std").math.Log2Int(usize), (@bitCast(c_ulong, @as(c_long, @as(c_int, 8))) *% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))), null);
}
...
pub fn _PyObject_CallMethodIdNoArgs(arg_self: [*c]PyObject, arg_name: [*c]_Py_Identifier) callconv(.C) [*c]PyObject {
    var self = arg_self;
    var name = arg_name;
    return _PyObject_VectorcallMethodId(name, &self, @bitCast(c_ulong, @as(c_long, @as(c_int, 1))) | (@bitCast(usize, @as(c_long, @as(c_int, 1))) << @intCast(@import("std").math.Log2Int(usize), (@bitCast(c_ulong, @as(c_long, @as(c_int, 8))) *% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))), null);
}
pub fn _PyObject_CallMethodIdOneArg(arg_self: [*c]PyObject, arg_name: [*c]_Py_Identifier, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (arg != @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {} else {
                __assert_fail("arg != NULL", "/usr/include/python3.9/cpython/abstract.h", @bitCast(c_uint, @as(c_int, 252)), "PyObject *_PyObject_CallMethodIdOneArg(PyObject *, _Py_Identifier *, PyObject *)");
            };
        };
    };
    return _PyObject_VectorcallMethodId(name, @ptrCast([*c][*c]PyObject, @alignCast(@import("std").meta.alignment([*c]PyObject), &args)), @bitCast(c_ulong, @as(c_long, @as(c_int, 2))) | (@bitCast(usize, @as(c_long, @as(c_int, 1))) << @intCast(@import("std").math.Log2Int(usize), (@bitCast(c_ulong, @as(c_long, @as(c_int, 8))) *% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))), null);
}
...
pub extern fn _Py_isabs(path: [*c]const wchar_t) c_int;
pub extern fn _Py_abspath(path: [*c]const wchar_t, abspath_p: [*c][*c]wchar_t) c_int;
...
pub export fn init_environment(arg_template_dir: [*c]const u8) ?*anyopaque {
    ...
    var pmodFileSystemLoader: [*c]PyObject = undefined;
    var pDict: [*c]PyObject = undefined;
    var pClassEnv: [*c]PyObject = undefined;
    var pClassFLoader: [*c]PyObject = undefined;
    var pArgs: [*c]PyObject = undefined;
    var pFileLoader: [*c]PyObject = undefined;
    var ret_env: [*c]PyObject = undefined;
    var empty_tuple: [*c]PyObject = undefined;
    Py_Initialize();
    pString = PyUnicode_FromString("jinja2.environment");
    pmodEnvironment = PyImport_Import(pString);
    _Py_DECREF(pString);
    if (!(pmodEnvironment != null)) {
    ...
    if (!(pClassEnv != null) or !(PyCallable_Check(pClassEnv) != 0)) {
        _ = fprintf(stderr, "Could not import Environment\n");
        PyErr_Print();
    ...
    if (!(pClassFLoader != null) or !(PyCallable_Check(pClassFLoader) != 0)) {
        _ = fprintf(stderr, "Could not import FileSystemLoader\n");
        PyErr_Print();
    ...
    _Py_DECREF(pArgs);
    if (pFileLoader == @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {
        _ = fprintf(stderr, "Could not instantiate a new FileSystemLoader\n");
        PyErr_Print();
        _Py_DECREF(pClassEnv);
    ...
    _Py_DECREF(pArgs);
    _Py_DECREF(empty_tuple);
    if (ret_env == @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {
        _ = fprintf(stderr, "Could not instantiate a new Environment\n");
        PyErr_Print();
...
pub export fn render(arg_tmpl: ?*anyopaque, arg_count: c_int, arg_args: [*c][*:0]const u8) [*c]PyObject {
    ...
    var pArgs: [*c]PyObject = undefined;
    var pString: [*c]PyObject = undefined;
    var pTmpl: [*c]PyObject = @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), tmpl));
    var i: c_int = undefined;
    //if (@import("std").zig.c_translation.signedRemainder(count, @as(c_int, 2)) != 0) {
    //    _ = fprintf(stderr, "The number of items given must be  \n");
    //    return null;
    //}
    if (count == @as(c_int, 0)) {
        pArgs = PyTuple_New(@bitCast(Py_ssize_t, @as(c_long, @as(c_int, 0))));
        pString = PyUnicode_FromString("render");
        retval = PyObject_CallMethodObjArgs(pTmpl, pString, pArgs, @intToPtr(?*anyopaque, @as(c_int, 0)));
        _Py_DECREF(pString);
        _Py_DECREF(pArgs);
    } else {
        pArgs = PyDict_New();
        {
            i = 0;
            while (i < count) : (i += @as(c_int, 2)) {
                pString = PyUnicode_FromString((blk: {
                    const tmp = i + @as(c_int, 1);
                    if (tmp >= 0) break :blk args + @intCast(usize, tmp) else break :blk args - ~@bitCast(usize, @intCast(isize, tmp) +% -1);
                }).*);
                _ = PyDict_SetItemString(pArgs, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk args + @intCast(usize, tmp) else break :blk args - ~@bitCast(usize, @intCast(isize, tmp) +% -1);
                }).*, pString);
                _Py_DECREF(pString);
    ...
    if (!(retval != null)) {
        _ = fprintf(stderr, "Could not list templates \n");
        PyErr_Print();
        return null;
    }
...
pub export fn list_templates(arg_env: ?*anyopaque) void {
    var env = arg_env;
    var retval: [*c]PyObject = undefined;
    var iterator: [*c]PyObject = undefined;
    var item: [*c]PyObject = undefined;
    var pEnv: [*c]PyObject = @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), env));
    ...
    if (iterator == @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {
        _ = fprintf(stderr, "Could not list templates \n");
        PyErr_Print();
        _Py_DECREF(retval);
        return;
    ...
    while ((blk: {
        const tmp = PyIter_Next(iterator);
        item = tmp;
        break :blk tmp;
    }) != null) {
...
pub export fn jinjify(arg_argc: c_int, arg_argv: [*c][*c]u8) c_int {
    var argc = arg_argc;
    _ = argc;
    var argv = arg_argv;
    _ = argv;
    var env: [*c]PyObject = undefined;
    var tmpl: [*c]PyObject = undefined;
    var rendered: [*c]PyObject = undefined;
    var vars: [*c][*:0]const u8 = undefined;
    env = @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), init_environment("/home/linux/Projects/jinja2-c/test_template/")));
    if (!(env != null)) {
        _ = fprintf(stderr, "Could not instantiate a new Environment\n");
        return -@as(c_int, 1);
    }
    list_templates(@ptrCast(?*anyopaque, env));
    tmpl = @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment(PyObject), get_template(@ptrCast(?*anyopaque, env), "index.html")));
    vars = @ptrCast([*c][*:0]const u8, @alignCast(@import("std").meta.alignment([*c][*:0]const u8), malloc(@sizeOf([*:0]const u8) *% @bitCast(c_ulong, @as(c_long, @as(c_int, 2))))));
    vars[@intCast(c_uint, @as(c_int, 0))] = "name";
    vars[@intCast(c_uint, @as(c_int, 1))] = "Zero";
    rendered = render(@ptrCast(?*anyopaque, tmpl), @as(c_int, 2), vars);
    free(@ptrCast(?*anyopaque, vars));
    if (rendered != null) {
...
pub const __CONCAT = @compileError("unable to translate C expr: unexpected token '##'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:123:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:124:9
...
pub const __errordecl = @compileError("unable to translate C expr: unexpected token 'extern'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:159:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token '['"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:167:10
...
pub const strdupa = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /usr/include/string.h:185:10
pub const strndupa = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /usr/include/string.h:195:10
...
pub const __ONCE_FLAG_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:127:9
pub const TEMP_FAILURE_RETRY = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /usr/include/unistd.h:1130:10
...
pub const Py_LOCAL = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.9/pyport.h:191:11
pub const Py_LOCAL_INLINE = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.9/pyport.h:192:11
...
pub const iszero = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /usr/include/math.h:1088:12
...
pub const _Py_SET_EDOM_FOR_NAN = @compileError("unable to translate C expr: unexpected token ';'"); // /usr/include/python3.9/pyport.h:330:9
pub const Py_SET_ERRNO_ON_MATH_ERROR = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.9/pyport.h:332:9
pub const Py_ADJUST_ERANGE1 = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.9/pyport.h:360:9
pub const Py_ADJUST_ERANGE2 = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.9/pyport.h:370:9
pub const _Py_SET_53BIT_PRECISION_HEADER = @compileError("unable to translate macro: undefined identifier `old_387controlword`"); // /usr/include/python3.9/pyport.h:408:9
pub const _Py_SET_53BIT_PRECISION_START = @compileError("unable to translate macro: undefined identifier `old_387controlword`"); // /usr/include/python3.9/pyport.h:410:9
pub const _Py_SET_53BIT_PRECISION_END = @compileError("unable to translate macro: undefined identifier `new_387controlword`"); // /usr/include/python3.9/pyport.h:417:9
pub const Py_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.9/pyport.h:508:9
pub const _Py_COMP_DIAG_PUSH = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /usr/include/python3.9/pyport.h:517:9
pub const _Py_COMP_DIAG_IGNORE_DEPR_DECLS = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /usr/include/python3.9/pyport.h:518:9
pub const _Py_COMP_DIAG_POP = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /usr/include/python3.9/pyport.h:520:9
pub const _Py_NO_INLINE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.9/pyport.h:569:11
pub const Py_IMPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.9/exports.h:20:17
pub const Py_EXPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.9/exports.h:21:17
pub const Py_LOCAL_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.9/exports.h:22:17
pub const PyAPI_DATA = @compileError("unable to translate C expr: unexpected token 'extern'"); // /usr/include/python3.9/pyport.h:701:16
pub const PyMODINIT_FUNC = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/python3.9/pyport.h:707:24
pub const Py_GCC_ATTRIBUTE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.9/pyport.h:755:9
pub const Py_ALIGNED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.9/pyport.h:762:9
pub const Py_LL = @compileError("unable to translate macro: undefined identifier `LL`"); // /usr/include/python3.9/pyport.h:775:9
pub const Py_ULL = @compileError("unable to translate macro: undefined identifier `U`"); // /usr/include/python3.9/pyport.h:779:9
pub const _Py_NO_RETURN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.9/pyport.h:859:11
pub const _Py__has_builtin = @compileError("unable to translate macro: undefined identifier `__has_builtin`"); // /usr/include/python3.9/pyport.h:872:11
pub const _Py_XSTRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.9/pymacro.h:13:9
pub const Py_MEMBER_SIZE = @compileError("unable to translate C expr: unexpected token '('"); // /usr/include/python3.9/pymacro.h:22:9
pub const Py_BUILD_ASSERT_EXPR = @compileError("unable to translate C expr: expected ')' instead got '['"); // /usr/include/python3.9/pymacro.h:39:9
pub const Py_BUILD_ASSERT = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.9/pymacro.h:42:9
pub const Py_ARRAY_LENGTH = @compileError("unable to translate macro: undefined identifier `__builtin_types_compatible_p`"); // /usr/include/python3.9/pymacro.h:59:9
pub const PyDoc_VAR = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.9/pymacro.h:70:9
pub const PyDoc_STRVAR = @compileError("unable to translate C expr: unexpected token '='"); // /usr/include/python3.9/pymacro.h:71:9
pub const Py_UNUSED = @compileError("unable to translate macro: undefined identifier `_unused_`"); // /usr/include/python3.9/pymacro.h:98:11
pub const Py_UNREACHABLE = @compileError("unable to translate macro: undefined identifier `__builtin_unreachable`"); // /usr/include/python3.9/pymacro.h:124:11
pub const _Py_IntegralTypeMax = @compileError("unable to translate C expr: expected ')' instead got 'IntegerLiteral'"); // /usr/include/python3.9/pymath.h:221:9
pub const PyObject_HEAD = @compileError("unable to translate macro: undefined identifier `ob_base`"); // /usr/include/python3.9/object.h:82:9
pub const PyObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.9/object.h:84:9
pub const PyVarObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.9/object.h:88:9
pub const PyObject_VAR_HEAD = @compileError("unable to translate macro: undefined identifier `ob_base`"); // /usr/include/python3.9/object.h:97:9
pub const _PyObject_CAST_CONST = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.9/object.h:113:9
pub const Py_CLEAR = @compileError("unable to translate macro: undefined identifier `_py_tmp`"); // /usr/include/python3.9/object.h:475:9
pub const Py_RETURN_NONE = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.9/object.h:520:9
pub const Py_RETURN_NOTIMPLEMENTED = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.9/object.h:530:9
pub const Py_RETURN_RICHCOMPARE = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.9/object.h:546:9
pub const _Py_static_string_init = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.9/cpython/object.h:51:9
pub const _Py_static_string = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.9/cpython/object.h:52:9
pub const _Py_IDENTIFIER = @compileError("unable to translate macro: undefined identifier `PyId_`"); // /usr/include/python3.9/cpython/object.h:53:9
pub const PyHeapType_GET_MEMBERS = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.9/cpython/object.h:297:9
pub const Py_SETREF = @compileError("unable to translate macro: undefined identifier `_py_tmp`"); // /usr/include/python3.9/cpython/object.h:366:9
pub const Py_XSETREF = @compileError("unable to translate macro: undefined identifier `_py_tmp`"); // /usr/include/python3.9/cpython/object.h:373:9
pub const _PyObject_ASSERT_WITH_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /usr/include/python3.9/cpython/object.h:422:9
pub const _PyObject_ASSERT_FAILED_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /usr/include/python3.9/cpython/object.h:427:9
pub const Py_TRASHCAN_BEGIN_CONDITION = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /usr/include/python3.9/cpython/object.h:525:9
pub const Py_TRASHCAN_END = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /usr/include/python3.9/cpython/object.h:537:9
pub const PyMem_New = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.9/pymem.h:78:9
pub const PyMem_NEW = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.9/pymem.h:81:9
pub const PyMem_Resize = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.9/pymem.h:91:9
pub const PyMem_RESIZE = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.9/pymem.h:94:9
pub const PyObject_New = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.9/objimpl.h:125:9
pub const PyObject_NewVar = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.9/objimpl.h:131:9
pub const PyObject_GC_Resize = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.9/objimpl.h:164:9
pub const PyObject_GC_New = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.9/objimpl.h:184:9
pub const PyObject_GC_NewVar = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.9/objimpl.h:186:9
pub const Py_VISIT = @compileError("unable to translate macro: undefined identifier `vret`"); // /usr/include/python3.9/objimpl.h:197:9
...
pub const PyUnicode_AS_DATA = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.9/cpython/unicodeobject.h:282:9
pub const PyUnicode_WRITE = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.9/cpython/unicodeobject.h:363:9
pub const PyUnicode_READ = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.9/cpython/unicodeobject.h:383:9
pub const PyUnicode_READ_CHAR = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.9/cpython/unicodeobject.h:397:9
pub const Py_RETURN_TRUE = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.9/boolobject.h:25:9
pub const Py_RETURN_FALSE = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.9/boolobject.h:26:9
pub const Py_RETURN_NAN = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.9/floatobject.h:27:9
pub const Py_RETURN_INF = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.9/floatobject.h:30:9
pub const PyTuple_SET_ITEM = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.9/cpython/tupleobject.h:30:9
pub const PyList_SET_ITEM = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.9/cpython/listobject.h:37:9
pub const PyModuleDef_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.9/moduleobject.h:51:9
pub const PyCell_SET = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.9/cellobject.h:23:9
pub const _PyGenObject_HEAD = @compileError("unable to translate macro: undefined identifier `_running`"); // /usr/include/python3.9/genobject.h:15:9
pub const PyDescr_COMMON = @compileError("unable to translate macro: undefined identifier `d_common`"); // /usr/include/python3.9/descrobject.h:48:9
pub const PyException_HEAD = @compileError("unable to translate macro: undefined identifier `dict`"); // /usr/include/python3.9/cpython/pyerrors.h:12:9
...
pub const Py_tss_NEEDS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.9/pythread.h:151:9
pub const PyModule_AddIntMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.9/modsupport.h:146:9
pub const PyModule_AddStringMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.9/modsupport.h:147:9
pub const Py_ALLOW_RECURSION = @compileError("unable to translate macro: undefined identifier `_old`"); // /usr/include/python3.9/ceval.h:70:9
pub const Py_END_ALLOW_RECURSION = @compileError("unable to translate macro: undefined identifier `_old`"); // /usr/include/python3.9/ceval.h:74:9
pub const Py_BEGIN_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /usr/include/python3.9/ceval.h:140:9
pub const Py_BLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /usr/include/python3.9/ceval.h:143:9
pub const Py_UNBLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /usr/include/python3.9/ceval.h:144:9
pub const Py_END_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /usr/include/python3.9/ceval.h:145:9
pub const PyFPE_START_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/python3.9/pyfpe.h:11:9
pub const PyFPE_END_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/python3.9/pyfpe.h:12:9
...
pub const PY_MINOR_VERSION = @as(c_int, 9);
pub const PY_MICRO_VERSION = @as(c_int, 7);
pub const PY_RELEASE_LEVEL = PY_RELEASE_LEVEL_FINAL;
pub const PY_RELEASE_SERIAL = @as(c_int, 0);
pub const PY_VERSION = "3.9.7";
...
pub const XCRYPT_VERSION_STR = "4.4.18";
...
pub inline fn Py_IS_TYPE(ob: anytype, @"type": anytype) @TypeOf(_Py_IS_TYPE(_PyObject_CAST_CONST(ob), @"type")) {
    return _Py_IS_TYPE(_PyObject_CAST_CONST(ob), @"type");
}
pub inline fn Py_SET_REFCNT(ob: anytype, refcnt: anytype) @TypeOf(_Py_SET_REFCNT(_PyObject_CAST(ob), refcnt)) {
    return _Py_SET_REFCNT(_PyObject_CAST(ob), refcnt);
}
pub inline fn Py_SET_TYPE(ob: anytype, @"type": anytype) @TypeOf(_Py_SET_TYPE(_PyObject_CAST(ob), @"type")) {
    return _Py_SET_TYPE(_PyObject_CAST(ob), @"type");
}
pub inline fn Py_SET_SIZE(ob: anytype, size: anytype) @TypeOf(_Py_SET_SIZE(_PyVarObject_CAST(ob), size)) {
    return _Py_SET_SIZE(_PyVarObject_CAST(ob), size);
}
pub inline fn PyObject_TypeCheck(ob: anytype, tp: anytype) @TypeOf((Py_IS_TYPE(ob, tp) != 0) or (PyType_IsSubtype(Py_TYPE(ob), tp) != 0)) {
    return (Py_IS_TYPE(ob, tp) != 0) or (PyType_IsSubtype(Py_TYPE(ob), tp) != 0);
}
...
pub inline fn Py_DECREF(op: anytype) @TypeOf(_Py_DECREF(_PyObject_CAST(op))) {
    return _Py_DECREF(_PyObject_CAST(op));
}
...
pub inline fn PyType_Check(op: anytype) @TypeOf(_PyType_Check(_PyObject_CAST(op))) {
    return _PyType_Check(_PyObject_CAST(op));
}
pub inline fn PyType_CheckExact(op: anytype) @TypeOf(_PyType_CheckExact(_PyObject_CAST(op))) {
    return _PyType_CheckExact(_PyObject_CAST(op));
}
...
pub inline fn PyUnicode_GET_SIZE(op: anytype) @TypeOf(if (@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr) PyUnicode_WSTR_LENGTH(op) else blk: {
    ...
    break :blk PyUnicode_WSTR_LENGTH(op);
}) {
    return blk: {
        _ = assert(PyUnicode_Check(op));
        break :blk if (@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr) PyUnicode_WSTR_LENGTH(op) else blk2: {
            _ = @import("std").zig.c_translation.cast(anyopaque, PyUnicode_AsUnicode(_PyObject_CAST(op)));
            _ = assert(@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr);
            break :blk2 PyUnicode_WSTR_LENGTH(op);
        };
    };
}
...
pub inline fn PyUnicode_WSTR_LENGTH(op: anytype) @TypeOf(_PyUnicode_get_wstr_length(@import("std").zig.c_translation.cast([*c]PyObject, op))) {
    return _PyUnicode_get_wstr_length(@import("std").zig.c_translation.cast([*c]PyObject, op));
}
...
pub inline fn _PyList_CAST(op: anytype) [*c]PyListObject {
    return blk: {
        _ = assert(PyList_Check(op));
        break :blk @import("std").zig.c_translation.cast([*c]PyListObject, op);
    };
}
pub inline fn PyList_GET_ITEM(op: anytype, i: anytype) @TypeOf(_PyList_CAST(op).*.ob_item[i]) {
    return _PyList_CAST(op).*.ob_item[i];
}
pub inline fn PyList_GET_SIZE(op: anytype) @TypeOf(Py_SIZE(_PyList_CAST(op))) {
    return Py_SIZE(_PyList_CAST(op));
}
pub inline fn _PyList_ITEMS(op: anytype) @TypeOf(_PyList_CAST(op).*.ob_item) {
    return _PyList_CAST(op).*.ob_item;
}
...
pub inline fn PyCFunction_GET_CLASS(func: anytype) @TypeOf(if (@import("std").zig.c_translation.cast([*c]PyCFunctionObject, func).*.m_ml.*.ml_flags & METH_METHOD) @import("std").zig.c_translation.cast([*c]PyCMethodObject, func).*.mm_class else NULL) {
    return if (@import("std").zig.c_translation.cast([*c]PyCFunctionObject, func).*.m_ml.*.ml_flags & METH_METHOD) @import("std").zig.c_translation.cast([*c]PyCMethodObject, func).*.mm_class else NULL;
}
...
pub const PY_TIMEOUT_MAX = LLONG_MAX / @as(c_int, 1000);
